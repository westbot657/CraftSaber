...
public class ServerNetworking {
    ...
    public static final Identifier STRUCTURE_SYNC = Identifier.of(CraftSaber.MOD_ID, "structure_sync");

    public static void init() {

        PayloadTypeRegistry.playS2C().register(LightInitPayload.ID, LightInitPayload.CODEC);
        PayloadTypeRegistry.playS2C().register(StructureSyncPayload.ID, StructureSyncPayload.CODEC);
    }
